...
<th colspan = 9 style='background-color:#FFFFFF;'> Newton Ranks (NEW)</th>
<!--<tr>
	<th> Rank </th>
	<th> Team </th>
	<th> QS </th>
...
<?php
	...
	$hcachefile = "../cachepages/newtonr.html";
	$xmlcachefile = "../cachepages/newtonr.xml";
	$cachelife = 60;
	$p = 0;
	
	$rankingsfile = "http://www2.usfirst.org/2013comp/Events/Newton/rankings.html";
