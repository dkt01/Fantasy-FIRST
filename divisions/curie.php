...
<th colspan = 9 style='background-color:#FFFFFF;'> Curie Ranks (CUR)</th>
<!--<tr>
	<th> Rank </th>
	<th> Team </th>
	<th> QS </th>
...
<?php
	...
	$hcachefile = "../cachepages/curier.html";
	$xmlcachefile = "../cachepages/curier.xml";
	$cachelife = 60;
	$p = 0;
	
	$rankingsfile = "http://www2.usfirst.org/2013comp/Events/Curie/rankings.html";
