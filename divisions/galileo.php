...
<th colspan = 9 style='background-color:#FFFFFF;'> Galileo Ranks (GAL)</th>
<!--<tr>
	<th> Rank </th>
	<th> Team </th>
	<th> QS </th>
...
<?php
	...
	$hcachefile = "../cachepages/galileor.html";
	$xmlcachefile = "../cachepages/galileor.xml";
	$cachelife = 60;
	$p = 0;
	
	$rankingsfile = "http://www2.usfirst.org/2013comp/Events/Galileo/rankings.html";
